...
$("#course-level").append("<h3>Avancerade hp: <span id='sum-advanced-points' class='number-value'></span></h3>");
$("#course-level").append("<h3 style='margin-top:5px;'>Övriga hp: <span class='number-value'id='sum-other-points'></span></h3>");
$("#course-level").append("<h3 style='margin-top:5px;'>Utland/Tests hp: <span class='number-value' id='sum-abroad-n-test-points'></span></h3>");
$("#course-level").append("<h3 style='margin-top:5px;'>Totalt hp: <span class='number-value'" +
